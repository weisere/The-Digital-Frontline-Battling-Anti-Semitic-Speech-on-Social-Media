import pandas as pd
from sklearn.feature_extraction.text import CountVectorizer  # Changed from TfidfVectorizer to CountVectorizer for BoW
...
# Convert the text data into numerical values using Bag of Words (BoW)
# BoW creates a matrix of token counts (number of times each word appears in the text)
...
# Transform the texts into a BoW feature matrix
