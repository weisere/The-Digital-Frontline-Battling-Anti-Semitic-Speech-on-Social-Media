...
svm = SVC(kernel='linear', class_weight='balanced')  # This added paramter is what we used to try fixing our
# unbalnced data
# 'linear' means it uses a straight line to separate the categories
